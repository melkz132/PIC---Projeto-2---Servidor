...
try {
			for (;;) {
				...
				if (comunicado == null || !comunicado.getComando().equals("CON"))
					return;
				System.out.println(this.conexao.toString());
		System.out.println(comunicado.toString());
				...
				ListaDeMusicas<Musica> listademusicas = null;
				...
				while (!(listademusicas == null)) {
					...
					Comunicado comunicadolista = new Comunicado("MUS", musica.getStyle(), musica.getSinger(),
